...
import { InMemoryComponentLibraryStore, builtinComponents } from "./component-library";
...
export const componentLibrary = new InMemoryComponentLibraryStore(builtinComponents);
