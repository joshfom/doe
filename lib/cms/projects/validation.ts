...
export const createProjectSchema = z.object({
  ...
  longDescriptionEn: z.string().trim().nullable().optional(),
  longDescriptionAr: z.string().trim().nullable().optional(),
  status: projectStatusEnum.optional(),
  heroImageId: z.string().uuid().nullable().optional(),
  logoImageId: z.string().uuid().nullable().optional(),
  brochurePdfId: z.string().uuid().nullable().optional(),
  ...
  developer: z.string().trim().max(200).nullable().optional(),
  contractor: z.string().trim().max(200).nullable().optional(),
  architect: z.string().trim().max(200).nullable().optional(),
  seoMeta: seoMetaSchema,
  // Custom landing page layout (Puck PageData JSON)
  landingPageData: z.any().nullable().optional(),
});
