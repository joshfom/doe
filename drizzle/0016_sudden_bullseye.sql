...
CREATE INDEX "admin_chat_messages_session_id_idx" ON "admin_chat_messages" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "admin_chat_sessions_user_id_idx" ON "admin_chat_sessions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "admin_chat_sessions_updated_at_idx" ON "admin_chat_sessions" USING btree ("updated_at");